...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "55@1aT7Nt%".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["soft.keeroyal.com"];
pub const RS_PUB_KEY: &str = "4SoNT0RDyNA0L0Bv6VsLzfikrFMJuz2qGhhRicnZ31Q=";
